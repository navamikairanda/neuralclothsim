...
class ReferenceGeometry(): 
    def __init__(self, curvilinear_coords: torch.Tensor, n_spatial_samples: int, n_temporal_samples: int, reference_midsurface: ReferenceMidSurface, tb_writer, debug=False):
        self.curvilinear_coords, self.n_spatial_samples, self.n_temporal_samples = curvilinear_coords, n_spatial_samples, n_temporal_samples
